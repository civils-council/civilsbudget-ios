...
//  Civilbudget
//
//  Created by Max Odnovolyk on 12/16/15.
...
public class CivilbudgetStyleKit : NSObject {
    ...
    public class var imageOfDetailsButtonBackground: UIImage {
        ...
        Cache.imageOfDetailsButtonBackground = UIGraphicsGetImageFromCurrentImageContext().resizableImageWithCapInsets(UIEdgeInsetsMake(8, 10, 8, 10), resizingMode: .Stretch)
        UIGraphicsEndImageContext()
