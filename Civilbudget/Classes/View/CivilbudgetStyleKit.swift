...
//  Civilbudget
//
//  Created by Max Odnovolyk on 12/15/15.
...
public class CivilbudgetStyleKit : NSObject {
    ...
    public class var imageOfDetailsButtonBackground: UIImage {
        ...
        Cache.imageOfDetailsButtonBackground = UIGraphicsGetImageFromCurrentImageContext().resizableImageWithCapInsets(UIEdgeInsetsMake(9, 10, 9, 10), resizingMode: .Stretch).imageWithRenderingMode(.AlwaysOriginal)
        UIGraphicsEndImageContext()
